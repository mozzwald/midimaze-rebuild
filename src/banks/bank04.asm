...
L7370	= $7370
	org $8000
; Bank-call slot entries. Each row is a fixed 3-byte JMP target selected by
; BANK_CALL_INDEXED; keep this table packed at $8000-$8029.
BANK4_NET_COMMAND_SERVICE_ENTRY	JMP	L8080	; slot $13
BANK4_SLOT14_SERVICE_ENTRY	JMP	L9D2F	; slot $14
BANK4_SLOT15_SERVICE_ENTRY	JMP	$8386	; slot $15
BANK4_SLOT16_SERVICE_ENTRY	JMP	L88BE	; slot $16
BANK4_SLOT17_SERVICE_ENTRY	JMP	$8898	; slot $17
BANK4_SLOT18_SERVICE_ENTRY	JMP	L94F4	; slot $18
BANK4_SLOT19_SERVICE_ENTRY	JMP	L8CDB	; slot $19
BANK4_SLOT1A_SERVICE_ENTRY	JMP	$8B53	; slot $1A
BANK4_NET_STATE_RESET_ENTRY	JMP	L8048	; slot $1B
BANK4_SLOT1C_SERVICE_ENTRY	JMP	L9205	; slot $1C
BANK4_SLOT1D_SERVICE_ENTRY	JMP	$8F4B	; slot $1D
BANK4_SLOT1E_SERVICE_ENTRY	JMP	$88AB	; slot $1E
BANK4_SLOT1F_SERVICE_ENTRY	JMP	$956B	; slot $1F
BANK4_SLOT24_SERVICE_ENTRY	JMP	L977B	; slot $24
L802A	LDA	RTCLOK+2
	CMP	L3ECE
	BMI	L8047
	CLC
...
L808E	LDA	HUMAN_PLAYER_COUNT
	...
	JMP	L8115
L80A1	JSR	MIDI_RX_HAS_BYTE
	BEQ	L811F
	JSR	MIDI_RX_READ_BLOCKING
	CMP	#$9B
	BNE	L80C5
	LDX	#$1C
	LDA	#$00
...
L80C5	CMP	#$7E
	...
	STA	L7363,X
L80D7	STA	L7362,X
	DEC	NET_INPUT_TRAIL_INDEX
	LDA	#$08
	BNE	L8110
L80E1	CMP	#$7F
	BNE	L80F0
	LDA	SETUP_SYNC_TOGGLE_FLAG
	EOR	#$01
...
L814B	ORA	L0080
	...
	BNE	L815B
	JMP	L821E
L815B	JSR	NET_CALL_VECTOR_1
	BNE	L8185
	LDX	LOCAL_PLAYER_INDEX
	LDA	PLAYER_INPUT_STATUS,X
	BPL	L8170
	LDA	L2B00,X
	JSR	NET_CALL_VECTOR_1
	BNE	L8185
L8170	LDA	LOCAL_PLAYER_INDEX
	STA	L3ECB
	INC	L3EB9
	CLC
	LDA	L00B3
...
L8295	DEY
	...
	STA	L3EBB,X
	BEQ	L82B9
L829F	JSR	PACK_DIRECTION_TO_STATUS_BITS
	STA	L0080
	LDX	L3ECB
	LDA	L3EBB,X
	TAY
...
L83FE	LDA	#$01
	STA	L0600,Y
	LDY	#$12
	LDA	PLAYER_PROJECTILE_SPEED_FLAG,X
	BEQ	L840B
	INY
L840B	LDA	#$01
	STA	L0600,Y
	LDY	#$15
	LDA	PLAYER_TURN_RATE,X
	CMP	#$08
	BEQ	L841A
	INY
L841A	LDA	#$01
...
L9826	STY	NET_ERROR_CODE
	...
	.byte	$36 ; '6' ; Screen code for 'V'
	.byte	$AF
L9AFE	JSR	CLEAR_STATUS_LINE_BUFFERS
	LDX	NET_ERROR_CODE
	BEQ	L9B27
	STX	L3EF0
	CPX	#$02
