...
LC785	= $C785
	org $8000
; Slot $02 entry: initialize player placement state and maze occupancy for the
; setup/game start flow.
BANK13_PLAYER_PLACEMENT_SETUP_ENTRY	LDA	#$01
	STA	L396D
	LDA	#$30
	STA	L0081
	LDA	#$20
...
L8037	JSR	L806F
	...
	LDA	#$00
	STA	PLAYER_FIRE_TIMER,X
	LDA	#$00
	STA	PLAYER_SCORE_COUNTERS,X
	LDA	#$00
	STA	PLAYER_HIT_FLAG,X
	LDA	#$00
	STA	PROJECTILE_ACTIVE_TIMER,X
	INC	FR1+2
	LDA	FR1+2
...
L8186	LDY	L29BD
	AND	LC785,X
	LDA	PLAYER_STATE_TIMER,X
	BEQ	L81DF
	DEC	PLAYER_STATE_TIMER,X
	BNE	L81DF
	INC	PLAYER_STATE,X
	LDA	PLAYER_STATE,X
	TAY
	CPY	#$03
	BCS	L81A7
	LDA	PLAYER_RELOAD_TIMER,X
	STA	PLAYER_STATE_TIMER,X
L81A7	CPY	#$01
	BNE	L81D0
	LDA	PLAYER_WEAPON_MODE,X
	STA	PLAYER_STATE,X
	CMP	#$03
	BNE	L81BA
	LDA	#$00
...
L81BA	STX	FR1+2
	...
	JMP	BANK_RETURN
L81C4	LDX	L00AC
	CPX	LOCAL_PLAYER_INDEX
	BNE	L81D0
	LDA	#$00
	STA	SETUP_SYNC_TOGGLE_FLAG
L81D0	CPX	LOCAL_PLAYER_INDEX
	BNE	L81DF
	LDA	#$01
	STA	L3DD7
	LDX	#$08
...
L81DF	LDX	L00AC
	LDA	PLAYER_STATE,X
	BNE	L81FD
	LDA	PROJECTILE_ACTIVE_TIMER,X
	BEQ	L81EE
	JSR	L85F2
L81EE	LDX	L00AC
	LDA	PLAYER_FIRE_TIMER,X
	BEQ	L81F8
	DEC	PLAYER_FIRE_TIMER,X
L81F8	LDA	#$01
	JMP	BANK_RETURN
L81FD	LDA	PLAYER_X_LO,X
	STA	L00B6
	LDA	PLAYER_X_HI,X
	STA	L00B7
	LDA	PLAYER_Y_LO,X
...
L824C	LDA	#$0A
	STA	PROJECTILE_ACTIVE_TIMER,X
	LDA	L00B6
	STA	PROJECTILE_X_LO,X
	LDA	L00B7
	STA	PROJECTILE_X_HI,X
	LDA	L00B8
	STA	PROJECTILE_Y_LO,X
	LDA	L00B9
	STA	PROJECTILE_Y_HI,X
	LDA	L00BA
	STA	L3A42,X
	JSR	L85B0
	LDA	PLAYER_FIRE_COOLDOWN,X
	STA	PLAYER_FIRE_TIMER,X
L8273	LDA	PROJECTILE_ACTIVE_TIMER,X
	BEQ	L827D
	JSR	L85F2
	LDX	L00AC
L827D	LDA	PLAYER_FIRE_TIMER,X
	BEQ	L8285
	DEC	PLAYER_FIRE_TIMER,X
L8285	LDY	#$00
	LDA	L00C7
...
L858F	CLC
	...
	JMP	L8358
L85B0	LDA	#$00
	STA	PROJECTILE_DX_HI,X
	SEC
	LDA	#$C0
	SBC	L00BA
	TAY
	LDA	L87EA,Y
	STA	PROJECTILE_DX_LO,X
	BPL	L85C6
	DEC	PROJECTILE_DX_HI,X
L85C6	LDA	#$00
	STA	PROJECTILE_DY_HI,X
	LDY	L00BA
	LDA	L87EA,Y
	STA	PROJECTILE_DY_LO,X
	BPL	L85D8
	DEC	PROJECTILE_DY_HI,X
L85D8	LDA	PLAYER_PROJECTILE_SPEED_FLAG,X
	BEQ	L85F1
	LDA	PROJECTILE_DX_HI,X
	ASL
	ROR	PROJECTILE_DX_HI,X
	ROR	PROJECTILE_DX_LO,X
	LDA	PROJECTILE_DY_HI,X
	ASL
	ROR	PROJECTILE_DY_HI,X
	ROR	PROJECTILE_DY_LO,X
L85F1	RTS
L85F2	LDA	PROJECTILE_X_LO,X
	STA	FR0+1
	LDA	PROJECTILE_X_HI,X
	STA	FR0+2
	STA	L00CF
	LDA	PROJECTILE_Y_LO,X
	STA	FR0+3
	LDA	PROJECTILE_Y_HI,X
	STA	FR0+4
	STA	L00D0
	LDA	L3A42,X
	STA	FR0+5
	LDA	PROJECTILE_DX_LO,X
	STA	FRE
	LDA	PROJECTILE_DX_HI,X
	STA	FRE+1
	LDA	PROJECTILE_DY_LO,X
	STA	FRE+2
	LDA	PROJECTILE_DY_HI,X
	STA	FRE+3
	LDA	#$01
...
L8770	LDX	L00C2
	...
	STA	PLAYER_HIT_FLAG,X
	LDA	L00AC
	STA	PLAYER_HIT_BY_INDEX,X
	LDA	SETUP_TEAM_PLAY_FLAG
	BEQ	L8797
	LDA	PLAYER_TEAM_INDEX,X
	CMP	PLAYER_TEAM_INDEX,Y
	BNE	L8797
	LDA	SETUP_TEAM_OPTION_FLAG
	BNE	L87D4
	LDA	PLAYER_STATE,X
	CMP	#$01
	BEQ	L87D4
L8797	LDA	PLAYER_RELOAD_TIMER,X
	STA	PLAYER_STATE_TIMER,X
	DEC	PLAYER_STATE,X
	BNE	L87CF
	LDA	PLAYER_PROJECTILE_LIFE,X
	STA	PLAYER_STATE_TIMER,X
	LDX	L00AC
	INC	PLAYER_SCORE_COUNTERS,X
	LDX	L00C2
	LDA	SETUP_TEAM_PLAY_FLAG
	BEQ	L87C3
	LDX	PLAYER_TEAM_INDEX,Y
	INC	TEAM_SCORE_COUNTERS,X
	LDA	TEAM_SCORE_COUNTERS,X
	CMP	#$0A
	BEQ	L87CA
	BNE	L87CF
L87C3	LDA	PLAYER_SCORE_COUNTERS,Y
	CMP	#$0A
	BNE	L87CF
L87CA	LDA	#$00
	STA	L396D
...
L87EA	.byte	$00 ; Screen code for ' '
	...
	.byte	$00 ; Screen code for ' '
	.byte	$00 ; Screen code for ' '
; Slot $10 entry. This landing pad is still byte-form because the surrounding
; region mixes code and data, but it dispatches setup placement work.
BANK13_SETUP_PLACEMENT_DISPATCH_ENTRY	.byte	$A2
	.byte	$02 ; Screen code for '"'
	.byte	$20 ; ' ' ; Screen code for '@'
	.byte	$1D ; Screen code for '='
	.byte	$AF
...
L8CC1	STA	L0081
	SEC
	SBC	HUMAN_PLAYER_COUNT
	SEC
	SBC	BOT_COUNT_TARGET
	BPL	L8CDA
	LDX	#$06
L8CCF	LDA	L8D48,X
	STA	L3EAC,X
...
L8D02	LDA	L8D5D,X
	...
	BPL	L8D02
L8D0B	LDX	#$07
	LDA	STARTUP_KEYBOARD_MODE_FLAG
	BEQ	L8D36
	LDA	#$09
	STA	L0080
	INC	L0081
...
L8DB3	RTS
	...
	.byte	$00 ; Screen code for ' '
	.byte	$00 ; Screen code for ' '
; Slot $0A entry. Copies status/playfield templates into display memory.
BANK13_STATUS_TEMPLATE_COPY_ENTRY	.byte	$A9
	.byte	$80
	.byte	$85
	.byte	$80
	.byte	$A9
	...
	.byte	$00 ; Screen code for ' '
	.byte	$03 ; Screen code for '#'
; Slot $0C entry. Refreshes bank 13's status display template area.
BANK13_STATUS_TEMPLATE_REFRESH_ENTRY	.byte	$A2
	.byte	$00 ; Screen code for ' '
L8E98	LDA	L9C80,X
	STA	L6000,X
L8E9E	LDA	L9D80,X
...
L8EB5	STA	L3DB7,X
	...
	BCC	L8EB5
	JMP	BANK_RETURN
; Slot $0D entry. High-traffic roster/status service used by setup polling.
BANK13_ROSTER_STATUS_SERVICE_ENTRY	.byte	$AD
L8EC1	INC	NOCKSM
	BEQ	L8EC8
	JMP	L8F87
L8EC8	LDA	TOTAL_PLAYER_COUNT
	BNE	L8ED0
	JMP	L8F84
L8ED0	LDX	#$00
	STX	L3EEC
L8ED5	LDA	L3DB7,X
	CMP	PLAYER_SCORE_COUNTERS,X
	BNE	L8EEE
	CPX	LOCAL_PLAYER_INDEX
	BEQ	L8EE5
	JMP	L8F76
...
L8F26	LDX	L3EEC
	...
	AND	#$20
	BEQ	L8F76
L8F34	LDA	PLAYER_SCORE_COUNTERS,X
	TAX
	CLC
	LDA	L907A,X
	ADC	L3EEC
...
L8F87	LDX	#$00
	STX	L3EEC
L8F8C	LDA	L3DB7,X
	CMP	TEAM_SCORE_COUNTERS,X
	BNE	L8FA9
	TXA
	LDY	LOCAL_PLAYER_INDEX
	CMP	PLAYER_TEAM_INDEX,Y
	BEQ	L8FA0
	JMP	L9037
L8FA0	LDA	RTCLOK+2
...
L9085	.byte	$62 ; 'b'
	...
	.byte	$60
	.byte	$60
; Slot $08 entry. Updates local-player status glyphs in the display buffers.
BANK13_LOCAL_STATUS_GLYPH_UPDATE_ENTRY	LDX	#$73
	JSR	L90CA
	LDX	#$63
	JSR	L90CA
	LDX	LOCAL_PLAYER_INDEX
...
L9110	ASL	L9596
	STA	L0095,X
; Slot $0F entry. Draw/update helper selected from bank 12 late setup flow.
BANK13_SLOT0F_DISPLAY_UPDATE_ENTRY	LDX	L3DB6
	BEQ	L9157
	DEX
	CPX	#$05
	BCS	L9137
...
L91E7	.byte	$00 ; Screen code for ' '
	...
	.byte	$80
	.byte	$00 ; Screen code for ' '
; Slot $0E entry. Status/display service landing pad, kept byte-form until the
; adjacent code/data boundary is proven.
BANK13_SLOT0E_STATUS_SERVICE_ENTRY	.byte	$A2
	.byte	$73 ; 's'
	.byte	$A5
	.byte	$8D
	.byte	$F0
...
L9596	.byte	$AA
	...
	.byte	$FF
	.byte	$FF
; Slot $0B entry. Clears or initializes display/status buffers.
BANK13_SLOT0B_STATUS_CLEAR_ENTRY	.byte	$A9
	.byte	$00 ; Screen code for ' '
	.byte	$A2
	.byte	$0F ; Screen code for '/'
	.byte	$9D
